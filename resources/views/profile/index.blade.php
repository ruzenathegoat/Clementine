...
<div x-data="archiveProfile()" class="w-full relative pb-24" id="archive-container" x-init="initGSAP()">
    ...
    <div class="w-full max-w-[1600px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-0 mt-12 relative" id="content-layout" x-data="{ mobileNavOpen: false }">
        ...
        <div class="fixed inset-y-0 left-0 z-[100] w-4/5 sm:w-80 bg-[#FAFAFA] border-r border-[rgba(10,10,10,0.15)] p-8 transform transition-transform duration-300 -translate-x-full lg:!relative lg:!translate-x-0 lg:!w-[280px] lg:!border-none lg:!p-0 lg:!bg-transparent lg:!flex-shrink-0 lg:!sticky lg:!top-32 h-max mb-12 lg:!mb-0 lg:!z-auto lg:!inset-auto"
                ...
                <div class="w-full mt-32 border-t border-[rgba(10,10,10,0.15)] pt-16" x-data="{ termModalOpen: false }">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                        ...
                        <div class="w-full lg:w-1/2">
                            <p class="font-body-md text-sm md:text-base text-[#555] leading-relaxed m-0 text-pretty">
                        ...
                        <!-- Button Column -->
                        <div class="w-full lg:w-1/4 flex lg:justify-end mt-4 lg:mt-0">
                            <button type="button" @click="termModalOpen = true" class="w-full lg:w-auto font-mono text-xs tracking-[0.2em] uppercase text-red-600 px-8 py-4 border border-red-600 hover:bg-red-600 hover:text-white transition-all duration-200 active:scale-[0.97]">
