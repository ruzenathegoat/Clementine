...
<div class="flex-1 w-full flex flex-col md:flex-row items-stretch bg-background" x-data="{ mobileMenuOpen: false }">
    ...
    <div class="flex-1 relative bg-background min-h-[50vh]">
        ...
        <div class="grid w-full content-start border-l-0 md:border-l border-primary grid-cols-2 md:grid-cols-[repeat(auto-fill,minmax(280px,1fr))]" id="catalog-grid">
...
<script nonce="{{ $cspNonce }}" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/Flip.min.js"></script>
