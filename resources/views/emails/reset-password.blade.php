        ...
        <div class="container">
            ...
            <div class="content">
                <p style="margin: 0 0 32px 0; font-size: 14px; line-height: 1.6;">
                    ...
                    A request has been made to reset the authentication credentials for your Clementine Horology account. To proceed and secure your access, please use the secure link below.
                </p>
            ...
            <div class="footer">
                <p style="margin: 0 0 8px 0; font-weight: bold;">Time Limit: {{ config('auth.passwords.'.config('auth.defaults.passwords').'.expire') }} Minutes</p>
