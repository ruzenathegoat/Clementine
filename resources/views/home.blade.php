    ...
    <section class="w-full bg-primary text-secondary py-32 md:py-40 relative overflow-hidden border-b border-secondary/15" id="provenance-section">
        ...
        <div class="w-full max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            ...
            <h2 class="font-h1 text-[clamp(2.2rem,5vw,4.2rem)] leading-[1.05] tracking-tight uppercase max-w-[820px] mb-8" style="font-weight: 500;">
                Every timepiece is <em class="not-italic text-secondary">authenticated</em><br>before it reaches your wrist.
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 border-t border-b border-secondary/15 mb-24 md:mb-32">
                <div class="p-8 md:p-10 border-b md:border-b-0 md:border-r border-secondary/15 hover:bg-white/5 transition-colors duration-300">
                    <div class="flex items-center justify-between font-mono text-[11px] text-secondary/40 tracking-[0.2em] mb-6">
                        <span>01</span><span class="w-[5px] h-[5px] rounded-full bg-secondary"></span>
                    </div>
                    <div class="font-h1 text-[15px] tracking-[0.02em] uppercase mb-4 leading-[1.3]" style="font-weight: 500;">Physical Inspection</div>
                    <div class="font-mono text-xs leading-[1.7] text-secondary/60">The movement, case, and dial are physically inspected by an AWCI/WOSTEP certified watchmaker and verified against original factory specifications.</div>
                </div>
                <div class="p-8 md:p-10 border-b md:border-b-0 md:border-r border-secondary/15 hover:bg-white/5 transition-colors duration-300">
                    <div class="flex items-center justify-between font-mono text-[11px] text-secondary/40 tracking-[0.2em] mb-6">
                        <span>02</span><span class="w-[5px] h-[5px] rounded-full bg-secondary"></span>
                    </div>
                    <div class="font-h1 text-[15px] tracking-[0.02em] uppercase mb-4 leading-[1.3]" style="font-weight: 500;">Digital Certification</div>
                    <div class="font-mono text-xs leading-[1.7] text-secondary/60">Inspection results are recorded as a digital certificate with a unique identifier, permanently linked to the movement's serial number.</div>
                </div>
                <div class="p-8 md:p-10 border-b md:border-b-0 md:border-r border-secondary/15 hover:bg-white/5 transition-colors duration-300">
                    <div class="flex items-center justify-between font-mono text-[11px] text-secondary/40 tracking-[0.2em] mb-6">
                        <span>03</span><span class="w-[5px] h-[5px] rounded-full bg-secondary"></span>
                    </div>
                    <div class="font-h1 text-[15px] tracking-[0.02em] uppercase mb-4 leading-[1.3]" style="font-weight: 500;">Provenance Tagging</div>
                    <div class="font-mono text-xs leading-[1.7] text-secondary/60">A hidden NFC tag is embedded in the packaging, enabling instant scanning of ownership history at any time after purchase.</div>
                </div>
                <div class="p-8 md:p-10 hover:bg-white/5 transition-colors duration-300">
                    <div class="flex items-center justify-between font-mono text-[11px] text-secondary/40 tracking-[0.2em] mb-6">
                        <span>04</span><span class="w-[5px] h-[5px] rounded-full bg-secondary"></span>
                    </div>
                    <div class="font-h1 text-[15px] tracking-[0.02em] uppercase mb-4 leading-[1.3]" style="font-weight: 500;">Insured Custody</div>
                    <div class="font-mono text-xs leading-[1.7] text-secondary/60">Shipments are fully insured by a third-party from our vault directly to your hands, complete with proof of handover.</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 border border-secondary/15 mb-24 md:mb-32">
                ...
                <div class="p-12 md:p-16 border-b lg:border-b-0 lg:border-r border-secondary/15 flex flex-col justify-center">
                    ...
                    <form action="/docs/verify" method="GET" class="flex border border-secondary/15">
                ...
                <div class="p-12 md:p-16 relative min-h-[380px] flex items-center justify-center overflow-hidden">
                    <div id="scanBeam" class="absolute left-0 right-0 h-[1px] top-[110%] opacity-0 pointer-events-none" style="background: linear-gradient(to right, transparent, #FFFFFF, transparent);"></div>
                    
                    <div class="relative w-[220px] h-[220px] flex items-center justify-center">
                        <div id="stampEl" class="w-full h-full rounded-full border-[1.5px] border-secondary/35 flex items-center justify-center opacity-0 transition-all duration-500 relative" style="transform: scale(0.6) rotate(-18deg); transition-timing-function: cubic-bezier(0.22, 1, 0.36, 1);">
                            <div class="absolute inset-[14px] rounded-full border border-secondary/35"></div>
                            <div class="text-center font-h1">
                                <div class="text-[34px] text-secondary leading-none mb-2">✓</div>
                        ...
                        <p id="idleCopy" class="absolute text-center font-mono text-[11px] text-secondary/40 tracking-[0.1em] uppercase max-w-[220px] leading-[1.8] transition-opacity duration-300">Enter your certificate number<br>to begin verification</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 pt-16 border-t border-secondary/15">
                ...
                <div class="border-l border-secondary/35 pl-6">
                    <p class="font-h1 text-base leading-[1.6] text-secondary mb-4">"I could scan the NFC tag on the box before transferring a single cent. That's what convinced me to purchase internationally."</p>
                    <div class="font-mono text-[11px] text-secondary/40 tracking-[0.05em] uppercase">— R. Hartono, Collector since 2019</div>
                </div>
            </div>
                    ...
                    <article class="note-module relative bg-background border border-primary/10 transition-colors duration-300 w-full cursor-pointer overflow-hidden group">
                        <div class="p-6 md:p-10 flex flex-col note-content-wrapper transition-all duration-500 relative z-10">
                            ...
                            <div class="note-img-wrapper w-full aspect-video bg-[#FAFAFA] overflow-hidden mb-10 relative">
                                <img src="{{ asset('images/products/Balance-wheel.webp') }}" class="note-img w-full h-full object-cover transform transition-transform duration-700 ease-out grayscale contrast-125 opacity-80" alt="Balance Wheel" style="clip-path: inset(0 0 100% 0);">
                            </div>
                    ...
                    <article class="note-module relative bg-background border border-primary/10 transition-colors duration-300 w-full md:w-[60%] ml-auto cursor-pointer overflow-hidden group">
                        <div class="p-6 md:p-10 flex flex-col note-content-wrapper transition-all duration-500 relative z-10">
                            ...
                            <div class="note-img-wrapper w-full aspect-square bg-[#FAFAFA] overflow-hidden mb-8 relative">
                                <img src="{{ asset('images/products/sapphire-crystal.jpg') }}" class="note-img w-full h-full object-cover transform transition-transform duration-700 ease-out grayscale contrast-125 opacity-80" alt="Sapphire Crystal" style="clip-path: inset(0 0 100% 0);">
                            </div>
